...
module.exports = {
  ...
  toogleFoldNonSelected() {
    return this.selectionManager.toogleFoldNonSelected();
  },

  // toogleAutofoldNonSelected() {
  //   this.selectionManager.enableAutofold = !this.selectionManager.enableAutofold;
  //   // return this.selectionManager.toogleFoldNonSelected();
  // },
  ...
  listenForCommands() {
    return atom.commands.add('atom-workspace', {
      ...
      'highlight-selected:toogle-fold-non-selected': () => this.toogleFoldNonSelected(),
      // 'highlight-selected:toogle-autofold-non-selected': () => this.toogleAutofoldNonSelected()
    });
  }
};
